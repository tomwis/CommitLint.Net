...
public class BlankLineBeforeFootersRuleTests
{
    ...
    [TestCase("fix: some bug fix", "", "BREAKING CHANGE: some breaking change", "Footer2: value1")]
    [TestCase("fix: some bug fix", "", "Footer1: value1", "BREAKING-CHANGE: some breaking change")]
