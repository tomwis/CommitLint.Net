...
public class BreakingChangeTokenInFooterRuleTests
{
    ...
    [TestCase("BREAKING-CHANGE")]
    public void WhenBreakingChangeFooterHasValidToken_ThenRuleIsValid(string breakingChangeToken)
    {
        // Arrange
    ...
    public void WhenBreakingChangeTokenIsAbsent_ThenRuleIsValid(params string[] commitMessageLines)
    {
        // Arrange
        var config = new ConventionalCommitConfig { Enabled = true };
        var rule = new BreakingChangeTokenInFooterRule(config);
